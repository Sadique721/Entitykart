...
class _SettingsScreenState extends State<SettingsScreen> {
  ...
  Future<void> _loadSavedSettings() async {
    ...
    final port = prefs.getString('backend_port') ?? '9999';
    setState(() {
      _ipController.text = ip;
      _portController.text = port;
      _currentTarget = ip.isNotEmpty ? 'http://$ip:$port' : 'http://10.0.2.2:9999 (default emulator)';
    });
  }
  ...
  Future<void> _resetToDefault() async {
    ...
    setState(() {
      _ipController.clear();
      _portController.text = '9999';
      _currentTarget = 'http://10.0.2.2:9999 (default emulator)';
      _saved = false;
    });
    ScaffoldMessenger.of(context).showSnackBar(
        ...
        child: Column(
          ...
          children: [
            ...
            TextField(
              ...
              decoration: _inputDecoration('e.g. 9999 (Monolith) or 9080 (Docker)'),
            ),
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  _helpStep('Then', 'Enter the IP above, select port 9999 (Monolith) or 9080 (Docker)'),
                ],
              ),
            ),
          ],
