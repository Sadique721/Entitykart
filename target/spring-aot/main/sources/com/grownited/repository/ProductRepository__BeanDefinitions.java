...
public class ProductRepository__BeanDefinitions {
  ...
  public static BeanDefinition getProductRepositoryBeanDefinition() {
    ...
    beanDefinition.setTargetType(ResolvableType.forClassWithGenerics(JpaRepositoryFactoryBean.class, ProductRepository.class, ProductEntity.class, Integer.class));
    beanDefinition.setLazyInit(false);
    beanDefinition.getConstructorArgumentValues().addIndexedArgumentValue(0, "com.grownited.repository.ProductRepository");
    ...
    beanDefinition.getPropertyValues().addPropertyValue("repositoryFragmentsFunction", new RepositoryFactoryBeanSupport.RepositoryFragmentsFunction() {
      public RepositoryComposition.RepositoryFragments getRepositoryFragments(
        ...
        return RepositoryComposition.RepositoryFragments.just(new com.grownited.repository.ProductRepositoryImpl__AotRepository(entityManager, context));
      }
    });
