...
public class AddressRepository__BeanDefinitions {
   ...
   */
  private static BeanInstanceSupplier<JpaRepositoryFactoryBean> getAddressRepositoryInstanceSupplier(
      ) {
  ...
  public static BeanDefinition getAddressRepositoryBeanDefinition() {
    ...
    beanDefinition.setTargetType(ResolvableType.forClassWithGenerics(JpaRepositoryFactoryBean.class, AddressRepository.class, AddressEntity.class, Integer.class));
    beanDefinition.setLazyInit(false);
    beanDefinition.getConstructorArgumentValues().addIndexedArgumentValue(0, "com.grownited.repository.AddressRepository");
    ...
    beanDefinition.getPropertyValues().addPropertyValue("repositoryFragments", new RuntimeBeanReference("jpa.AddressRepository.fragments#0"));
    ...
    beanDefinition.getPropertyValues().addPropertyValue("repositoryFragmentsFunction", new RepositoryFactoryBeanSupport.RepositoryFragmentsFunction() {
      public RepositoryComposition.RepositoryFragments getRepositoryFragments(
        ...
        return RepositoryComposition.RepositoryFragments.just(new com.grownited.repository.AddressRepositoryImpl__AotRepository(entityManager, context));
      }
    });
    InstanceSupplier<JpaRepositoryFactoryBean> instanceSupplier = getAddressRepositoryInstanceSupplier();
